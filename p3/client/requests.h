...
void req_kvi(int sd, RSA *pubkey, const std::string &user,
...
/// @param key     The key to be set
/// @param valfile The file whose contents should be sent as the value
void req_kvu(int sd, RSA *pubkey, const std::string &user,
             const std::string &pass, const std::string &key,
             const std::string &valfile);
...
void req_kva(int sd, RSA *pubkey, const std::string &user,
...
void req_kvg(int sd, RSA *pubkey, const std::string &user,
             const std::string &pass, const std::string &key,
             const std::string &);
...
/// @param pass    The password of the user doing the request
/// @param key     The key to be set
void req_kvd(int sd, RSA *pubkey, const std::string &user,
             const std::string &pass, const std::string &key,
             const std::string &);
